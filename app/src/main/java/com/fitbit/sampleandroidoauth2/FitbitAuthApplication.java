...
public class FitbitAuthApplication extends Application {
    ...
    private static final String CLIENT_SECRET = "494f5897d93fd3361e4c8db52cd6a6bb";
    private static String backup = "86401692efd006045a157f45755000d0";
    private static String backup2 = "CVPdQNAT6fBI4rrPLEn9x0+UV84DoqLFiNHpKOPLRW0";
    ...
    public static AuthenticationConfiguration generateAuthenticationConfiguration(Context context, Class<? extends Activity> mainActivityClass) {
        ...
        try {
            ...
            return new AuthenticationConfigurationBuilder()
                    ...
                    .addOptionalScopes(Scope.activity, Scope.heartrate, Scope.weight)
